...
const CATS = [
  {
    ...
    books: [
      { t: 'The Culting of Brands', url: 'https://amzn.eu/d/2cyTKGJ', es: 'Cómo las marcas se convierten en comunidades con un propósito casi religioso.', en: 'How brands become communities with an almost religious sense of purpose.' },
      ...
      { t: 'I Love It. What Is It?', url: 'https://amzn.eu/d/bc9OP9e', es: 'La intuición y la emoción como ejes del diseño y la marca.', en: 'Instinct and emotion as the core of design and branding.' },
      { t: 'The Business of Belonging', url: 'https://amzn.eu/d/8sKPN2j', es: 'Cómo construir comunidades que fortalezcan la ventaja competitiva.', en: 'How to build communities that strengthen competitive advantage.' },
      { t: 'Get Together', url: 'https://amzn.eu/d/75hKT4W', es: 'Manual para crear comunidades de marca auténticas y sostenibles.', en: 'A manual for building authentic, sustainable brand communities.' },
      { t: 'Obsessed', url: 'https://amzn.eu/d/eGaquTP', es: 'Cómo crear marcas queridas desde el día uno.', en: 'How to build brands people love from day one.' },
      { t: 'El libro rojo de las marcas', url: 'https://amzn.eu/d/4F5NozX', es: 'Principios esenciales para construir marcas icónicas.', en: 'Essential principles for building iconic brands.' },
      ...
      { t: 'Point of Purpose', url: 'https://www.point-of-purpose.com', es: 'Cómo construir marcas guiadas por propósito y significado.', en: 'How to build brands guided by purpose and meaning.' },
      ...
      { t: 'Ugly Is Only Skin-Deep', url: 'https://www.amazon.es/dp/B077KY21YG', es: 'Las campañas que transformaron la comunicación comercial (Think Small).', en: 'The campaigns that transformed commercial communication (Think Small).' },
      { t: "Bill Bernbach's Book", url: 'https://amzn.eu/d/2nqNlc6', es: 'Homenaje al pionero de la creatividad publicitaria moderna.', en: 'A tribute to the pioneer of modern advertising creativity.' },
      { t: 'The Book of Gossage', url: 'https://www.amazon.es/Book-Gossage-Howard-Luck/dp/1887229280', es: 'Retrato del outsider que anticipó el marketing participativo.', en: 'A portrait of the outsider who anticipated participatory marketing.' },
  ...
  },
  {
    ...
    books: [
      ...
      { t: 'Good Authority', url: 'https://amzn.eu/d/265Coon', es: 'Cómo ejercer una autoridad sana basada en la confianza y la responsabilidad compartida.', en: 'How to exercise healthy authority based on trust and shared responsibility.' },
      ...
      { t: 'ReCulturing', url: 'https://amzn.eu/d/244LbPd', es: 'Rediseñar la cultura de empresa para alinearla con estrategia y propósito.', en: 'Redesigning company culture to align it with strategy and purpose.' },
      ...
      { t: 'Cuando las arañas tejen juntas pueden atar a un león', url: 'https://amzn.eu/d/eZtqdGr', es: 'Manifiesto sobre la fuerza del trabajo colectivo como base del liderazgo.', en: 'A manifesto on the power of collective work as the basis of leadership.' },
      ...
      { t: 'Meaning at Work', url: 'https://amzn.to/47zRJMd', es: 'Cómo el lenguaje simbólico y emocional da sentido al trabajo.', en: 'How symbolic and emotional language gives meaning to work.' },
  ...
  },
  {
    ...
    books: [
      ...
      { t: 'Museum of Capitalism', url: 'https://www.inventorypress.com/product/museum-of-capitalism', es: 'Proyecto artístico que convierte el capitalismo en objeto museístico.', en: 'An art project that turns capitalism into a museum object, questioning its symbols.' },
      ...
      { t: 'Crea', url: 'https://amzn.eu/d/dxNPyKK', es: 'Guía poco ortodoxa para hacer cosas que marquen la diferencia.', en: 'An unorthodox guide to making things that make a difference.' },
  ...
  },
  {
    ...
    books: [
      ...
      { t: 'Exponential Organizations', url: 'https://amzn.to/4otylWQ', es: 'Por qué algunas empresas crecen 10 veces más rápido.', en: 'Why some companies grow ten times faster.' },
      ...
      { t: 'Powerhouse: The Untold Story of CAA', url: 'https://amzn.to/42RLFMy', es: 'La agencia que cambió para siempre el negocio del entretenimiento.', en: 'The agency that changed the entertainment business forever.' },
      { t: 'Those Guys Have All the Fun: Inside ESPN', url: 'https://amzn.to/49eEXnx', es: 'Crónica del imperio mediático de ESPN y su cultura interna.', en: "A chronicle of ESPN's media empire and its internal culture." },
  ...
  },
  {
    ...
    books: [
      ...
      { t: 'La marca de Dios', url: 'https://amzn.eu/d/3o5R9z4', es: 'El cristianismo como la marca cultural más influyente de la historia.', en: 'Christianity as the most influential cultural brand in history.' },
      ...
      { t: 'La vía de la narración', url: 'https://amzn.eu/d/5FGYTrF', es: 'La narración como herramienta esencial de conocimiento, memoria e identidad.', en: 'Narrative as an essential tool for knowledge, memory and identity.' },
      ...
      { t: 'Hipercomplejidad', url: 'https://www.amazon.es/s?k=hipercomplejidad+libro', es: 'Cómo pensar y decidir en un mundo de sistemas cada vez más complejos.', en: 'How to think and decide in a world of ever more complex systems.' },
              ...
              {cat.books.map((b, i) => (
                <div key={i} className="py-5 hairline-b grid md:grid-cols-12 gap-2 md:gap-6" style={{ borderColor: 'rgba(22,21,19,0.08)' }}>
                  <div className="md:col-span-5">
                    {b.url ? (
                      <a href={b.url} target="_blank" rel="noreferrer" className="link-u serif-i text-[19px] md:text-[21px] leading-snug" style={{ color: 'var(--ink)' }}>
                        {b.t}
                      </a>
                    ) : (
                  ...
                  <div className="md:col-span-7 flex items-start justify-between gap-4">
                    ...
                    {b.url && (
                      <a href={b.url} target="_blank" rel="noreferrer" className="mono text-[10px] uppercase tracking-[0.14em] link-u shrink-0 hidden md:inline" style={{ color: 'var(--ink-35)' }}>
                        {t.get} →
                      </a>
                    )}
                  </div>
