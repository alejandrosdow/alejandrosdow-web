...
const CATS = [
  {
    ...
    books: [
      ...
      { t: 'House of Errors — Brand Book', url: 'https://www.houseoferrors.org/products/five-years-of-errors', es: 'La marca como arte, imperfección y cultura alternativa.', en: 'Brand as art, imperfection and alternative culture.' },
      ...
      { t: 'Just Doing It: A History of Advertising', a: 'Pia Elliott', url: 'https://www.amazon.es/dp/B00S1YMW4E', es: 'La historia de la publicidad y sus figuras clave.', en: 'The history of advertising and its key figures.' },
  ...
  },
  {
    ...
    books: [
      ...
      { t: 'Seeing <—> Making: Room for Thought', a: 'Buck-Morss, McCaughey & Michaels', url: 'https://www.amazon.es/dp/1941753531', es: 'Libro visual que invita a ver el proceso creativo como una forma de pensamiento.', en: 'A visual book that treats the creative process as a form of thinking in itself.' },
      ...
      { t: 'Atlas of Modern Clothing', a: 'Marina Madzhugina', url: 'https://www.amazon.es/dp/841765660X', es: 'Recorrido visual por la evolución del diseño textil y su impacto en la identidad moderna.', en: 'A visual journey through textile design and its impact on modern identity.' },
      { t: 'Textilepedia', a: 'Fashionary', url: 'https://www.amazon.es/dp/9887711098', es: 'Enciclopedia práctica sobre tejidos, materiales y técnicas para el diseño de moda.', en: 'A practical encyclopedia of fabrics, materials and techniques for fashion design.' },
  ...
  },
  {
    ...
    books: [
      ...
      { t: 'Capitalismo para el siglo XXI', a: 'José Luis Antúnez', url: 'https://www.dropbox.com/scl/fi/phrod8eics1qqziisg2cj/capitalismo.pdf?rlkey=5b6l9xvll1q6dh83ewhnz72xs&st=wcpc0f94&e=1&dl=0', es: 'Cómo reformular el sistema económico hacia un modelo más sostenible, humano y ético.', en: 'Rethinking the economic system toward a more sustainable, human and ethical model.' },
