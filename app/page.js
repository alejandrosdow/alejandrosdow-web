...
const UI = {
  es: {
    ...
    soonText: ['Estoy preparando esta sección con calma. Mientras tanto, lee ', { k: 'cv', label: 'lo que construyo' }, ' o ', { k: 'cv', label: 'mi trayectoria' }, '.'],
  ...
  en: {
    ...
    soonText: ["I'm putting this section together carefully. Meanwhile, read ", { k: 'cv', label: 'what I’m building' }, ' or ', { k: 'cv', label: 'my career' }, '.'],
