...
export const THREADS = {
  ...
  origenes: {
    ...
    es: {
      ...
      body: [
        ['Todo empieza en 2008 con Call of Duty y YouTube. Fui campeón nacional con Pain Gaming y quedé 9º en el Mundial de Los Ángeles 2011, y subía a YouTube mis partidas, mis viajes y series de contenido.'],
        ...
        ['Después llegó GAME, donde con 24 años lideraba las relaciones con publishers y creadores, y las activaciones en eventos masivos como Madrid Gaming Experience, Barcelona Games World o Fun & Serious. Luego vinieron empresas como Movistar o Cooler Master, donde seguí creciendo mientras me apuntaba a otras aventuras.'],
        ['Llegó Team Heretics y pasamos de ser tres personas en Google Campus a casi 80 en 2026, surfeando la ola de los esports, el gaming y las tendencias digitales. Mientras, como siempre, he seguido lanzándome a trabajar y colaborar en proyectos de tecnología, creación de contenido y plataformas.'],
    ...
    en: {
      ...
      body: [
        ...
        ['Then came GAME, where at 24 I led relationships with publishers and creators, and activations at major events like Madrid Gaming Experience, Barcelona Games World and Fun & Serious. Later came companies like Movistar and Cooler Master, where I kept growing while signing up for other adventures.'],
        ['Then Team Heretics arrived, and we went from three people at Google Campus to almost 80 in 2026, riding the wave of esports, gaming and digital trends. Meanwhile, as always, I kept jumping into work and collaborations in technology, content creation and platforms.'],
